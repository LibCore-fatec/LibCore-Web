      ...
      <div className="cps-card p-5">
        ...
        <div className="mt-5 space-y-3">
          {loanRecords.map((loan) => {
            const renewed = renewedLoanIds.includes(loan.id);
            return (
              <div
                key={loan.id}
